...
export const Home = () => {
    ...
    <h1>Traillo - management made easy.</h1>
    <p>Take productivity to another level, from business to personal use. Whether you collab with others or work alone, you can accomplish anything with Traillo.</p>
