...
export const BoxList = ({labelFilter,newBoardFilter, boxes, board, onAddTask }) => {
            ...
            return <Draggable key={box.id} draggableId={box.id} index={index}>
                {provided => {
                    return <div {...provided.draggableProps} {...provided.dragHandleProps} ref={provided.innerRef} index={index} >
                        <BoxPreview labelFilter={labelFilter} newBoardFilter={newBoardFilter} index={index} editTitleId={editTitleId}
