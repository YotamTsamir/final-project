            ...
            {menuBtns.map(btn => {
                return (
                    <div>
                        ...
                        {/* {(menuState['Edit labels']) && btn.txt === 'Edit labels' && <LabelMenu className="label-choice" topic={'Labels'} setIsEdit={setIsEdit} onEditTaskTitle={onEditTaskTitle} task={task} box={box} board={board} />} */}
